...
const themeStorageKey = 'sneat-theme';
...
const getPreferredTheme = () => {
  ...
  const htmlTheme = rootElement.getAttribute('data-bs-theme');
...
const applyTheme = theme => {
  ...
  rootElement.classList.toggle('theme-dark', resolvedTheme === 'dark');
...
if (colorSchemeMedia) {
  ...
  if (typeof colorSchemeMedia.addEventListener === 'function') {
    colorSchemeMedia.addEventListener('change', mediaChangeHandler);
  } else if (typeof colorSchemeMedia.addListener === 'function') {
    colorSchemeMedia.addListener(mediaChangeHandler);
  }
}
