...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Cabang Toko</h5>
            <div class="d-flex gap-2">
                <a href="{{ route('products.index') }}" class="btn btn-outline-secondary"><i class="bx bx-arrow-back me-1"></i>Kembali ke Produk</a>
                @if(auth()->user()->hasPermission('master.branches.create'))
                    <a href="{{ route('branches.create') }}" class="btn btn-primary"><i class="bx bx-plus me-1"></i>Tambah Cabang</a>
                @endif
            </div>
        </div>
        <div class="card-body">
...
$(function(){ 
    $('#branches-table').DataTable({
        ...
        columns: [
            ...
            {data: 'name', name: 'name'},
            {data: 'code', name: 'code'},
            {data: 'main_badge', name: 'is_main', orderable: false, searchable: false},
