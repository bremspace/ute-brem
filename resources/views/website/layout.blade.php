    ...
    <div class="consumer-layout">
        ...
        <nav class="consumer-nav" role="navigation" aria-label="Navigasi utama">
            <div class="consumer-nav-inner">
                ...
                {{-- Logo --}}
                <a href="{{ route('website.products.index') }}" class="consumer-logo" aria-label="{{ $appCompanyName ?? 'UTE Parts' }} — Beranda">
                    ...
                    <span>{{ $appCompanyName ?? 'UTE Parts' }}</span>
                </a>
        ...
        <footer class="consumer-footer">
            <div class="consumer-footer-inner">
                <div class="consumer-footer-grid">
                    ...
                    {{-- Brand --}}
                    <div>
                        <div class="consumer-footer-brand">{{ $appCompanyName ?? 'UTE Parts' }}</div>
                        <p class="consumer-footer-desc">
                            Toko sparepart HP terlengkap. Menyediakan LCD, baterai, charger, casing, dan aksesoris HP berkualitas dengan harga terbaik.
                        </p>
                ...
                <div class="consumer-footer-bottom">
                    <span class="consumer-footer-copyright">&copy; {{ date('Y') }} {{ $appCompanyName ?? 'UTE Parts' }}. Hak cipta dilindungi.</span>
                </div>
            </div>
        </footer>
