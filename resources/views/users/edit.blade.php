        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if(session('success') && request()->is('*/edit'))
                            <div class="alert alert-success alert-dismissible py-2 px-3" role="alert">
                                {{ session('success') }}
                        ...
                        <form action="{{ route('users.update', $user) }}" method="POST">
                            ...
                            @method('PUT')
                            <div class="mb-3">
                                <label class="form-label" for="branch_id">Assign ke Cabang</label>
                            ...
                            <button type="submit" class="btn btn-primary btn-sm">
                                <i class="bx bx-save me-1"></i> Simpan Cabang
                            </button>
                        </form>
                    </div>
                </div>
