...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('users.index')
            ->with('success', "User berhasil dibuat. User: {$user->name} ({$user->username})");
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('users.edit', compact('user', 'permissions', 'roleTemplates', 'branches'));
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        UserLog::log('UPDATE_USER_BRANCH', "Updated branch assignment for user: {$user->name}", $user, $oldValues, $user->fresh()->toArray());

        return redirect()->route('users.edit', $user)->with('success', 'Cabang user berhasil diperbarui');
    }
